...
import json 
nltk.download('punkt')
cvkeywordsIDF = 'vac-keywords-IDF.csv'
cvkeywordsTF = 'vac-keywords-TF.csv'
cvkeywordsTFIDF = 'vac-keywords-TFIDF.csv'

def update_file(data,filename):     
     with open(filename, 'w', newline='') as write_file:
          writer = csv.writer(write_file)
          if filename == 'vac-keywords-TFIDF.csv':
...
def calculate_tf():
     with open('vac-content2.csv', 'r') as file:
